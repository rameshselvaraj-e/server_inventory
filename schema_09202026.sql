...
--
-- Table structure for table `cable_inventory`
--

DROP TABLE IF EXISTS `cable_inventory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cable_inventory` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cable_name` varchar(150) NOT NULL,
  `cable_type` enum('Cat','DAC','Fiber','RJ45','SFP+','QSFP+','QSFP28','Other') DEFAULT 'Other',
  `length_m` decimal(6,2) DEFAULT NULL,
  `data_gbps` decimal(8,2) DEFAULT NULL,
  ...
  `condition_state` enum('new','used','damaged','disposed') DEFAULT 'new',
  `status` enum('in_stock','in_use','reserved','disposed') DEFAULT 'in_stock',
  `notes` text,
...
--
-- Dumping data for table `cable_inventory`
--

LOCK TABLES `cable_inventory` WRITE;
/*!40000 ALTER TABLE `cable_inventory` DISABLE KEYS */;
INSERT INTO `cable_inventory` VALUES (1,'Cat5 Patch Cable 1m Blue','Cat',5.00,10.00,'ADDON','UTPSP1BUY','adb12345678',5,4,1,'Santa Clara','Santa Clara','R12','Dell','2023-01-31','used','in_stock','New Project','2026-09-21 02:00:59','2026-09-21 03:54:20'),(7,'Cat5 Patch Cable 1m Blue','Cat',5.00,10.00,'CISCO','UTPSP1BUY','adb12345678',5,4,1,'Santa Clara','Santa Clara','R12','Panduit','2023-01-15','new','in_stock','New Project','2026-09-21 02:03:05','2026-09-21 04:05:33'),(8,'Cat6 Patch Cable 2m Yellow','Cat',10.00,10.00,'CISCO','UTPSP1BUY','adb12345678',5,3,2,'Santa Clara','Santa Clara','R12','Panduit','2023-01-15','new','in_stock','New Project','2026-09-21 02:03:05','2026-09-21 02:03:05'),(9,'25G QSFP28 DAC 1m','DAC',10.00,25.00,'CISCO','UTPSP1BUY','adb12345678',5,3,2,'Santa Clara','Santa Clara','R12','Panduit','2023-01-15','new','in_stock','New Project','2026-09-21 02:03:05','2026-09-21 02:03:05'),(10,'10G SFP+ DAC 1m','DAC',10.00,10.00,'CISCO','UTPSP1BUY','adb12345678',5,3,2,'Santa Clara','Santa Clara','R12','Panduit','2023-01-15','new','in_stock','New Project','2026-09-21 02:03:05','2026-09-21 02:03:05'),(11,'Fiber OM4 10m','Fiber',10.00,100.00,'CISCO','UTPSP1BUY','adb12345678',5,3,2,'Santa Clara','Santa Clara','R12','HPE','2023-01-15','new','in_stock','New Project','2026-09-21 02:03:05','2026-09-21 04:05:51'),(12,'25G DAC Cable 3M','DAC',3.00,25.00,'DELL','DAC-25G-UPSGFD','adb12345678',10,4,6,'DC-US-East','DC-East','R12-U040','System Tech','2026-07-01','new','in_stock','New Purchase','2026-09-21 04:15:24','2026-09-21 04:15:40'),(13,'25G DAC Cable 3M','Fiber',10.00,40.00,'CISCO','UTPSP1BUY','adb12345ikmj',6,1,5,'Santa Clara','DC-1','RACK-A-34','Dell','2026-09-08','new','in_stock','New Purchase','2026-09-21 04:41:08','2026-09-21 04:41:08');
/*!40000 ALTER TABLE `cable_inventory` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-09-21  4:45:33
